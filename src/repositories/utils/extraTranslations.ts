...
const detailTranslations: { [key: string]: string } = {
    "en": "Involving the people",
    "fr": "Impliquer les gens",
    "nl": "De mensen betrekken",
    "sr": "Укључивање народа",
    "hi": "लोगों को शामिल करना",
    "ja": "人々を巻き込む",
    "zh": "让人民参与",
    "es": "Involucrando a la gente",
    "pt": "Envolvendo o povo",
    "no": "Involvere folket",
    "de": "Die Menschen einbeziehen",
    "it": "Coinvolgere le persone",
    "ru": "Вовлечение людей",
    "ko": "사람들을 참여시키기",
    "ar": "إشراك الناس",
    "sv": "Involvera folket",
    "da": "Involvere folket",
    "fi": "Ihmisten osallistaminen",
    "pl": "Zaangażowanie ludzi",
    "tr": "İnsanları dahil etmek",
    "el": "Εμπλοκή των πολιτών",
    "id": "Melibatkan masyarakat",
    "uk": "Залучення людей",
    "vi": "Thu hút người dân tham gia",
    "th": "การมีส่วนร่วมของประชาชน",
    "he": "שילוב האנשים",
    "hu": "Az emberek bevonása",
